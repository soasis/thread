...
/// @brief An enumeration con[tianing all of the standard and implementation-defined thread attributes.
///
...
typedef struct ztdc_thrd_attr_name {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_name.
...
typedef struct ztdc_thrd_attr_name_sized {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_name_sized.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr_mcname {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_mcname.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr_mcname_sized {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_mcname_sized.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr_mwcname {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_mwcname.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr_mwcname_sized {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_mwcname_sized.
	ztdc_thrd_attr_kind kind;
	/// @brief The size of the name. Must not include a null terminator in its range.
	size_t size;
	/// @brief The wide execution encoding name.
...
typedef struct ztdc_thrd_attr_c8name {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_c8name.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr_c8name_sized {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_c8name_sized.
	ztdc_thrd_attr_kind kind;
	/// @brief The size of the name. Must not include a null terminator in its range.
	size_t size;
...
typedef struct ztdc_thrd_attr_c16name {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_c16name.
	ztdc_thrd_attr_kind kind;
	/// @brief The UTF-8 encoding name.
...
typedef struct ztdc_thrd_attr_c16name_sized {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_c16name_sized.
	ztdc_thrd_attr_kind kind;
	/// @brief The size of the name. Must not include a null terminator in its range.
	size_t size;
	/// @brief The UTF-8 encoding name.
...
typedef struct ztdc_thrd_attr_c32name {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_c32name.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr_c32name_sized {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_c32name_sized.
	ztdc_thrd_attr_kind kind;
	/// @brief The size of the name. Must not include a null terminator in its range.
	size_t size;
...
typedef struct ztdc_thrd_attr_stack_size {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_stack_size.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr_detached {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind_detached.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thrd_attr__stack_storage {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind__stack_storage.
	ztdc_thrd_attr_kind kind;
...
typedef struct ztdc_thread_attr__stack_guard_size {
	/// @brief The kind of the attribute. Must be ztd_thrd_attr_kind__stack_guard_size.
	ztdc_thrd_attr_kind kind;
