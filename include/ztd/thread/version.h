...
#if defined(ZTD_THREAD_INTEGER_THREAD_ID)
	#if (ZTD_THREAD_INTEGER_THREAD_ID) != 0
		#define ZTD_THREAD_INTEGER_THREAD_ID_I_ ZTD_ON
	#else
		#define ZTD_THREAD_INTEGER_THREAD_ID_I_ ZTD_OFF
	#endif
#elif ZTD_IS_ON(ZTD_PLATFORM_WINDOWS) && ZTD_IS_OFF(ZTD_THREAD_PTHREAD_BASED)
	#define ZTD_THREAD_INTEGER_THREAD_ID_I_ ZTD_DEFAULT_ON
#elif ZTD_IS_ON(ZTD_THREAD_PTHREAD_BASED) && ZTD_IS_ON(ZTD_HEADER_PTHREAD_NP_H) && ZTD_IS_ON(ZTD_PLATFORM_FREE_BSD)
	#define ZTD_THREAD_INTEGER_THREAD_ID_I_ ZTD_DEFAULT_ON
#elif ZTD_IS_ON(ZTD_PLATFORM_FREE_BSD)
	#define ZTD_THREAD_INTEGER_THREAD_ID_I_ ZTD_DEFAULT_ON
#else
	#define ZTD_THREAD_INTEGER_THREAD_ID_I_ ZTD_DEFAULT_OFF
#endif
